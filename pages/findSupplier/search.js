...
Page({
  ...
  */
  searchIconClicked: function (e) {
    this.beginSearch(this.data.searchText);
  },
  /**
   * 输入框键盘搜索
   */
  searchInputConfirmed: function (e) {
    console.log('begin:' + this.data.searchText)
    this.beginSearch(this.data.searchText);
  },
  ...
  getRecentSearches:function(){
    // 从本地存储获取最近搜索
    return wx.getStorageSync('recent_search') || [];
  },
  ...
  addRecentSearch:function(text) {
    ...
    wx.setStorageSync('recent_search', recents);
  },
